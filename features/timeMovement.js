function enableTimeMovementHotkeys(key1, key2) {
  ...
  function keyHandler(e) {
    if ((e.key === key1 || e.key === key2) && !e.ctrlKey)
      document.getElementsByClassName('chart-page')[0].dispatchEvent(new KeyboardEvent(e.type, {'keyCode': e.key === key1 ? 37 : 39, 'altKey': true, 'bubbles': true}));
  }
